...
def adjust_indices(
    ...
    flat_sents = flatten(sents)[:MAX_TOKS]
    new_idxs = []
...
if __name__ == '__main__':
    ...
    parser.add_argument('-t', '--time', help='Option to show estimated time remaining',
                        action='store_true')
    parser.add_argument('--maxtoks', type=int, help='Maximum tokens per training document.')
    parser.add_argument('-r', '--read', action='store_true')
    args = parser.parse_args()

    MAX_TOKS = args.maxtoks
